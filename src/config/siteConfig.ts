...
export const siteConfig: SiteConfig = {
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/logo/logo.svg",
			alt: "🍀",
		},
		// 导航栏标题
		title: "Yinx",
	...
	analytics: {
		...
		umamiAnalytics: {
			// Umami Website ID
			websiteId: "b826886d-c557-4ee6-90a2-6803f5b48f45",
			// Umami JS地址，支持使用自建
			scriptUrl: "https://umami.yinn.eu.org/script.js",
			// Umami 会话回放脚本地址，支持使用自建
			replaysScriptUrl: "https://umami.yinn.eu.org/recorder.js",
			// 是否追踪出站链接
